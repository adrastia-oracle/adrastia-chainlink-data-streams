...
import {AdrastiaWorldChainDataStreamsUpdater} from "../../../updater/AdrastiaWorldChainDataStreamsUpdater.sol";
...
import {WorldChainFeedStub} from "../../WorldChainFeedStub.sol";
import {UpdaterStub} from "../../UpdaterStub.sol";

contract WorldChainUpdaterTest is Test, FeedConstants, FeedDataFixture {
    VerifierStub internal verifierStub;

    WorldChainFeedStub internal ethUsdV3Feed;
    WorldChainFeedStub internal btcUsdV3Feed;

    WorldChainFeedStub internal ethUsdV3Feed2;
    WorldChainFeedStub internal btcUsdV3Feed2;
    ...
    function setUp() public {
        ...
        ethUsdV3Feed = new WorldChainFeedStub(
            address(verifierStub),
            ETH_USD_V3.feedId,
            ETH_USD_V3.decimals,
            ETH_USD_V3.description
        );
        ethUsdV3Feed2 = new WorldChainFeedStub(
            address(verifierStub),
            ETH_USD_V3.feedId,
            ETH_USD_V3.decimals,
            ETH_USD_V3.description
        ...
        btcUsdV3Feed = new WorldChainFeedStub(
            address(verifierStub),
            BTC_USD_V3.feedId,
            BTC_USD_V3.decimals,
            BTC_USD_V3.description
        );
        btcUsdV3Feed2 = new WorldChainFeedStub(
            address(verifierStub),
            BTC_USD_V3.feedId,
            BTC_USD_V3.decimals,
            BTC_USD_V3.description
    ...
    function test_constructor_deploysCorrectly() public {
        ...
        AdrastiaWorldChainDataStreamsUpdater updater = new AdrastiaWorldChainDataStreamsUpdater(
            address(verifierStub),
            initialAdmin
        );
    ...
    function test_constructor_revertsWhenAdminIsZero() public {
        ...
        new AdrastiaWorldChainDataStreamsUpdater(address(verifierStub), address(0));
    }

    function test_constructor_revertsWhenVerifierProxyIsZero() public {
        vm.expectRevert("Invalid verifier proxy address");
        new AdrastiaWorldChainDataStreamsUpdater(address(0), address(0x123));
    }
    ...
    function test_registerFeed_registersOneFeed() public {
        ...
        AdrastiaWorldChainDataStreamsUpdater.FeedIdAndAddress[] memory feedAddresses = updater.getFeedMapping();
    ...
    function test_approveVerifierFeeSpend_isNoOp() public {
        AdrastiaWorldChainDataStreamsUpdater updater = new AdrastiaWorldChainDataStreamsUpdater(
            address(verifierStub),
            address(this)
        );
